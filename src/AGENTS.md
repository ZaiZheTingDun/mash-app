...
- Use Radix theme tokens in `App.css` (`var(--gray-*)`, `var(--blue-*)`, `var(--radius-*)`) instead of hard-coded colors. Any custom color should support both light and dark mode through CSS variables.
